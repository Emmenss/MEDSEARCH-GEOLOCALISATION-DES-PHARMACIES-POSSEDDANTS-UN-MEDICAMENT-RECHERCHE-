...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <img src="../assets/img/l.png" alt="..." style="width:500vh;height:500vh">
        <span class="ms-3 font-weight-bold">MEDSEARCH</span>
    </a>
  </div>
 ...
 --}}
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('accueil') ? 'active' : '') }}" href="{{ url('accueil') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title> Find medoc </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(0.000000, 148.000000)">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">GESTION DES PROFILS</h6>
      </li>
      <li class="nav-item">
       ...
       <!-- Condition pour afficher le menu uniquement pour les enseignants -->
      ...
      @if(auth()->user() && auth()->user()->profil === 'pharmacie')
      <li class="nav-item">
